...
public function getLeVisiteur($leVisiteur){
	$req = "select visiteur.id as id, visiteur.nom as nom, visiteur.prenom as prenom from  visiteur where visiteur.nom = '$leVisiteur' 
	order by visiteur.nom asc ";
	$res = PdoGsb::$monPdo->query($req);
	$visiteur =array();
	$laLigne = $res->fetch();
 ...
 */
	...
	/**
 * Modifie l'état des montants et quantités d'une fiche de frais
...
public function updateFrais($idFrais, $quantite,$visiteur){
